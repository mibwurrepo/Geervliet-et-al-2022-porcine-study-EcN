...
***Purpose of analysis***
To visualize the alpha diversity of the GIT microbiota in faeces and digesta over time, and in between treatment groups.
...
This folder contains three PDF files with parts of the figure that were generated by R. 
These PDF files were used to create Figure S9. 
