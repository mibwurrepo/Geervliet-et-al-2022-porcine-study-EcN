...
This README file corresponds to the datafiles that are present in the folder "EcN-specific_qPCR_original_datafiles".
...
This folder contains info regarding the samples that were selected for the EcN-specific qPCR analysis. It additionally contains the raw qPCR datafile (in .pcrd format), and it contains the plate setup and results in the file named "qPCR_plate_setup_and_results".
