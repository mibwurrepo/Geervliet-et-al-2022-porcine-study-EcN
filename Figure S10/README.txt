...
This README file corresponds to the data corresponding to Figure S10 of the manuscript.
...
***Purpose of analysis***
To visualize the differences in abundance and diversity of ASVs within the phylum Proteobacteria in between treatment groups, in faecal samples, during the pre-weaning phase. For this purpose, a heatmap was used.
...
In the Figure S10 folder, two subfoldors can be found, namely:

1. Unprocessed_Figure:
This folder contains the PDF file with the figure as generated by R. 
This PDF file was used to create Figure S10. 
