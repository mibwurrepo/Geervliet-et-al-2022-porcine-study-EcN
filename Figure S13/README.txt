...
This README file corresponds to the data corresponding to Figure S13 of the manuscript.
...
***Purpose of analysis***
To visualize the relative abundance of ASVs within the genus Treponema_2 in faecal samples over time, and in between treatment groups. The bottom figure is used to visualize the relative abundance of two ASVs within 
the genus Treponema2 in faecal samples over time, and in between treatment groups. These two ASVs are linked to a species of Treponema that is associated with colitis (Candidatus Treponema suis).

***Methodological information***
DNA was extracted from faecal samples, then PCR amplification was carried out with barcoded primers directed to the V4 region 
...
In the Figure S13 folder, two subfoldors can be found, namely:

1. Unprocessed_Figure:
This folder contains two PDF files with the figures as generated by R. 
These PDF files were used to create Figure S13. 
