...
This README file corresponds to the data corresponding to Figure S11 of the manuscript.
...
***Purpose of analysis***
To visualize genera that have a differential relative abundance in between treatment groups, during the pre-weaning period. 
...
In the Figure S11 folder, two subfoldors can be found, namely:

1. Unprocessed_Figure:
This folder contains the PDF file with the figure as generated by R. 
This PDF file was used to create Figure S11. 
